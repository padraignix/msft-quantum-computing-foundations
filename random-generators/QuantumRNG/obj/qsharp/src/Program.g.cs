...
{
    [SourceLocation("C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs", OperationFunctor.Body, 9, 20)]
...
#line hidden
            {
#line 11 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
                var q = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 13 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(q);
#line 16 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
...
#line hidden
    ...
    [SourceLocation("C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs", OperationFunctor.Body, 20, 33)]
    public partial class SampleRandomNumberInRange : Operation<Int64, Int64>, ICallable
    {
        ...
        {
            var max = __in__;
#line 21 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
            var output = 0L;
#line 22 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
            while (true)
            {
#line 23 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
                var bits = QArray<Result>.Create(0L);
#line 24 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
                foreach (var idxBit in new QRange(1L, Microsoft__Quantum__Math__BitSizeI.Apply(max)))
#line hidden
                {
#line 25 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
                    bits = QArray<Result>.Add(bits, new QArray<Result>(GenerateRandomBit__.Apply(QVoid.Instance)));
                }

#line 27 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
...
#line 29 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
            return output;
        }
    ...
    [SourceLocation("C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs", OperationFunctor.Body, 33, -1)]
    public partial class SampleRandomNumber : Operation<QVoid, Int64>, ICallable
    {
        ...
        {
#line 34 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
            var max = 50L;
#line 35 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
            Message__.Apply(String.Format("Sampling a random number between 0 and {0}: ", max));
#line 36 "C:\\Users\\padra\\OneDrive\\Documents\\GitHub\\msft-quantum-foundations\\random-generators\\QuantumRNG\\Program.qs"
